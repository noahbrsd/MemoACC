        ...
        try
        {
            ...
            switch (messageType)
            {
                case InboundMessageTypes.REGISTRATION_RESULT:
                    {
                        // Console.WriteLine("Processing REGISTRATION_RESULT...");
                ...
                case InboundMessageTypes.ENTRY_LIST:
                    {
                        // Console.WriteLine("Processing ENTRY_LIST...");
                ...
                case InboundMessageTypes.ENTRY_LIST_CAR:
                    {
                        ...
                        // Console.WriteLine("Processing ENTRY_LIST_CAR...");
                        var carInfo = _entryListCars.SingleOrDefault(x => x.CarIndex == carId);
                        if (carInfo == null)
                        {
                            // Console.WriteLine($"Car with index {carId} not found in ENTRY_LIST_CAR.");
                            break;
                        }
                        ...
                        for (int di = 0; di < driversOnCarCount; di++)
                        {
                            ...
                            // foreach (var driver in carInfo.Drivers)
                            // {
